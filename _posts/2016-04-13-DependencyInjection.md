...
## 说明
16年4月12日下午,我试着给自己的毕设写一个爬虫程序.由于一贯的的眼高手低我开始时无从下手,所以先从GitHub上clone了一个Java实现的简单爬虫学习一下人家的写法,给自己一个思路.
然而可悲的是这么简单的爬虫代码自己却看不懂,起初连main方法都没有找到(心里在嘲笑自己的无能).在我找到入口之后再一次的懵逼又来袭了！
